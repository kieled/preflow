...
/**
 * TextCode — a virtualizer optimized for code/monospace line rendering.
 * Uses the flow composable with a fixed line height.
 */
export const TextCode = defineComponent({
	name: "TextCode",
	props: {
